...
export const userConfig: UserConfig = {
	...
	imageOptimizeConfig: {
		...
		tasks: [
			...
			{
				name: "Mobile Banner", // 任务名称
				dir: "dist/assets/mobile-banner", // 构建后输出目录
				maxWidth: 800, // 最大宽度
				maxHeight: 1200, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Home Images", // 任务名称
				dir: "dist/assets/home", // 构建后输出目录
				maxWidth: 256, // 最大宽度
				maxHeight: 256, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Avatar", // 任务名称
				dir: "dist/_astro", // 构建后输出目录
				sourceDir: "src/assets/images", // 源目录，用于匹配源文件到输出目录
				maxWidth: 256, // 最大宽度
				maxHeight: 256, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Anime Covers", // 任务名称
				dir: "dist/assets/anime", // 构建后输出目录
				maxWidth: 450, // 最大宽度
				maxHeight: 600, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Albums", // 任务名称
				dir: "dist/images/albums", // 构建后输出目录
				maxWidth: 1920, // 最大宽度
				maxHeight: 1080, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Post Covers", // 任务名称
				dir: "dist/_astro", // 构建后输出目录
				sourceDir: "src/content/posts", // 源目录，用于匹配源文件到输出目录
				maxWidth: 1920, // 最大宽度
				maxHeight: 1080, // 最大高度
			},
			{
				name: "Posts", // 任务名称
				dir: "dist/images/posts", // 构建后输出目录
				maxWidth: 1920, // 最大宽度
				maxHeight: 1080, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Sponsors", // 任务名称
				dir: "dist/images/sponsors", // 构建后输出目录
				maxWidth: 600, // 最大宽度
				maxHeight: 600, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			{
				name: "Contact QR", // 任务名称
				dir: "dist/images/contact", // 构建后输出目录
				maxWidth: 600, // 最大宽度
				maxHeight: 600, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
			...
			{
				name: "Device", // 任务名称
				dir: "dist/images/device", // 构建后输出目录
				maxWidth: 800, // 最大宽度
				maxHeight: 800, // 最大高度
				recursive: true, // 是否递归处理子目录
			},
	...
	sakuraConfig: {
		enable: true, // 启用樱花特效（Appearance UI 中显示开关）
		uiDefaultEnabled: false, // 默认开启樱花特效 （已开启 Appearance UI 生效）
		sakuraNum: 10, // 樱花数量
