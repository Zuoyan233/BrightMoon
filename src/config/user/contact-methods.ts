...
export const userContactMethods: Partial<ContactMethods> = [
	// 联系方式配置，支持微信、QQ、Telegram 等
	{
		method: "wechat",
		label: "WeChat",
		icon: "simple-icons:wechat",
		qrCode: "/images/contact/wechat friend.webp", // 微信二维码图片路径
	...
	},
	{
		...
		qrCode: "/images/contact/qq friend.webp", // QQ 二维码图片路径
	...
	},
	{
		...
		qrCode: "/images/contact/telegram friend.webp", // Telegram 二维码图片路径
